...
from . import views, staff_views, window_views, auth_views, service_views, analytics_views, session_views
...
urlpatterns = [
    ...
    path('sessions/release', session_views.release_session, name='release-session'),
